...
parser.add_argument('-i', metavar='FASTA_FILE', help='Input Fatsa file (default = inputs/msa_input.fas)', default='inputs/msa_input.fasta')
...
mafft_cline = MafftCommandline(thread=8, reorder=True, treeout= True, maxiterate=2, amino=True, input=input_file)
