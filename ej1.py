...
parser = argparse.ArgumentParser(
    description="Ejercicio 1. Nucleotide GenBank -> Protein FASTA"
)
parser.add_argument(
    "-i",
...
parser.add_argument(
    "-o",
    help="Output Fatsa file (default = results/secuencias.fasta)",
    default="results/secuencias.fasta",
)
...
def save_orfs_to_file(record, orfs, output_file):
    ...
    file_path = "results/secuencias_n.fasta"
